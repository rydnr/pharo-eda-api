{
  description = "Flake for rydnr/pharo-eda-api";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        homepage = "https://github.com/rydnr/pharo-eda-api";
        maintainers = with pkgs.lib.maintainers; [ ];
        nixpkgsVersion = builtins.readFile "${nixpkgs}/.version";
        nixpkgsRelease =
          builtins.replaceStrings [ "\n" ] [ "" ] "nixpkgs-${nixpkgsVersion}";
        shared = import ./nix/shared.nix;
        pharo-eda-api-for = { bootstrap-image-name, bootstrap-image-sha256, bootstrap-image-url, pharo-vm, pharo-eda-common }:
          let
          ...
          in pkgs.stdenv.mkDerivation (finalAttrs: {
            ...
            configurePhase = ''
              ...
              substituteInPlace src/BaselineOfPharoEDAApi/BaselineOfPharoEDAApi.class.st \
            ...
            meta = {
              changelog = "https://github.com/rydnr/pharo-eda-api/releases/";
              longDescription = ''
      ...
      in rec {
        ...
        devShells = rec {
          ...
          pharo-eda-api-12 = shared.devShell-for {
            package = packages.pharo-eda-api-12;
