...
rec {
  shellHook-for = { nixpkgs-release, org, package, repo, tag }:
    ''
      ...
      echo -e "\033[34m     |                   \033[0m        \033[32m    |\033[0m        \033[35m          o  \033[32mhttps://github.com/${org}\033[0m"
      ...
      echo -e "\033[34m|---'\`   '\`---^\`    \`---'\033[0m   \033[31m\`---'\033[32m\`---'\033[36m\`---^\033[0m   \033[35m\`---^|---'\`  \033[34mhttps://pharo.org\033[0m"
      echo -e "\033[34m|                        \033[0m                     \033[35m     |       \033[35mhttps://github.com/nixos/nixpkgs/tree/${nixpkgs-release}\033[0m"
      echo
